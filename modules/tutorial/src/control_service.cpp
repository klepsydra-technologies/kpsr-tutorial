...
kpsr::ControlService::ControlService(Environment * environment,
...
void kpsr::ControlService::start() {
    ...
    std::function<void(kpsr::sensors::Temperature)> temperatureListenerFn = std::bind(
        &ControlService::onTemperatureReceived, this, std::placeholders::_1);
